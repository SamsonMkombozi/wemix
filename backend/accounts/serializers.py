...
class PasswordResetRequestSerializer(serializers.Serializer):
    """Deliberately never reveals whether the email matches an account --
    the view returns the same generic response either way (see
    PasswordResetRequestView). This serializer just validates shape."""
